...
<a-scene raycaster-manager>
    <a-entity id="left-hand" meta-touch-controls="hand: left">
        <a-entity class="styled-ray ar-left" visible="false" rotation="60 0 0" sound="src: #raycaster-beep; volume: .1;">
            <a-cylinder position="0 -0.5 0" height="1" radius="0.002" color="#ffffff" opacity=".4"></a-cylinder>
        </a-entity>
        <a-entity class="actual-ray" rotation="-30 0 0"  raycaster="objects: .interactable; autoRefresh: false; enabled: false; showLine: false; lineColor: red"></a-entity>
    </a-entity>
    <a-entity id="right-hand" meta-touch-controls="hand: right">
        <a-entity class="styled-ray ar-right" visible="false" rotation="60 0 0" sound="src: #raycaster-beep; volume: .1;">
            <a-cylinder position="0 -0.5 0" height="1" radius="0.002" color="#ffffff" opacity=".4"></a-cylinder>
        </a-entity>
        <a-entity class="actual-ray" rotation="-30 0 0"  raycaster="objects: .interactable; autoRefresh: false; enabled: false; showLine: false; lineColor: red"></a-entity>
    </a-entity>
